...
class Overview extends React.Component {
    ...
    constructor(props){
        super(props);
        let incomeData = this.props.location.state.incomeData;
        console.log('props expense data: ', incomeData);
    ...
    handleIncome=(e)=>{
        ...
        if(this.state.type==='' || this.state.amount===''){
            ...
            axios.put(Config.base_url + '/addincome/' + localStorage.getItem('userid'), {
    ...
    handleDelete=(e)=>{
        ...
        axios.delete(Config.base_url+'/addincome/'+localStorage.getItem('userid'), {
                    ...
                    <Grid  item xs={12} sm={6} >
                        ...
                        <div style={{margin: '15px'}}>
                            ...
                            <Paper style={{padding:'15px', paddingBottom: '100px'}} elevation={10}>
                                <SelectIncomeType value={this.state.type} onChange={this.handleSelectType}/>
                                <div>
                                ...
                                <div style={{marginTop: '30px', marginBottom: '30px'}}>
                                    ...
                                    <Button fullWidth={true}   variant="contained" color="secondary" onClick={this.handleIncome}>
                                        SUBMIT
                                    </Button>
                                </div>
                            </Paper>
