    ...
    <Grid  container spacing={0}>
        ...
        <Grid style={{textAlign:'center', marginTop:'50px', paddingTop:'100px', paddingBottom:'300px'}} item xs={12} sm={6}>
            ...
            <div style={{marginBottom:'15px'}}>
                <Typography variant={'body2'}>No expense data to show</Typography>

            </div>

            <Typography variant={'body2'}>Add any expense you have incurred before you forget it!</Typography>
        ...
        if(event.target.value.length===0){
            ...
            this.state.backupdata.map(val => {
                if(val.title!==null) {
                    ...
                    if (val.title.toString().toLowerCase().includes(event.target.value.toLowerCase())) {
                                            ...
                                            <CardContent className={classes.content} onClick={()=>this.handleDateClick(val)}>
                                                ...
                                                <div style={{width:'100%', display:'inline-block'}}>
                                                    <div style={{ float:'left'}}>
                                                        <Typography  name={'date'} component="h6" variant="h6">{val.date}</Typography>
